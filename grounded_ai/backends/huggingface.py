...
class HuggingFaceBackend(BaseEvaluator):
    ...
    def __init__(self, model_id: str, device: str = None, task: str = None, input_schema: Type[BaseModel] = None, output_schema: Type[BaseModel] = None, **kwargs):
    ...
    def _evaluate_classification(self, input_data: EvaluationInput, output_schema: Type[BaseModel] = None) -> BaseModel:
    ...
    def _evaluate_generation(self, input_data: EvaluationInput, output_schema: Type[BaseModel] = None) -> BaseModel:
