...
class BaseEvaluator(ABC):
    ...
    def __init__(self, input_schema: Type[BaseModel] = None, output_schema: Type[BaseModel] = None):
    ...
    def evaluate(self, input_data: Union[BaseModel, Dict[str, Any]], output_schema: Type[BaseModel] = None) -> Union[BaseModel, EvaluationError]:
        """
        Run the evaluation.
