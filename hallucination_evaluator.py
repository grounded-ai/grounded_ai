...
class HallucinationEvaluator:
    ...
    def __init__(self, base_model_id, groundedai_eval_id, quantization=False):
    ...
    def load_model(self, base_model_id, groundedai_eval_id):
    ...
    def format_func(self, query, response, reference=None):
    ...
    def run_model(self, query, response, reference=None):
    ...
    def evaluate(self, data):
        ...
        for item in data:
            ...
            if output == "yes":
                ...
                truthful += 1
        percentage_hallucinated = (hallucinated / len(data)) * 100
        return {
